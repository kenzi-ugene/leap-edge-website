    ...
    return (
        <div data-screen-label="Studio">
            <Reveal as="section" style={{ ...section, paddingBottom: '56px' }}>
                ...
                <h1 style={{ ...h1, maxWidth: '820px' }}>A renovation team that treats your home like its own</h1>
                <p style={{ ...body, maxWidth: '640px', margin: 0 }}>
                    With over 10 years’ experience, Leap Edge Renovation has completed renovation and extension projects across Penang Mainland, Kedah and Perak. Our in-house team of project managers, site supervisors, and tradesmen means you deal with one company from site inspection to final handover.
                </p>
            </Reveal>
            ...
            <Reveal as="section" style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 40px 72px', display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '24px' }}>
                ...
                <ImageSlot id="studio-detail" placeholder="Showroom detail" shape="rounded" style={imgBlock('420px')} />
            </Reveal>
            ...
            <Reveal as="section" style={{ ...section, padding: '80px 40px', display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(min(380px,100%),1fr))', gap: 'clamp(36px,5vw,64px)', alignItems: 'center' }}>
                <ImageSlot id="studio-founders" placeholder="Project manager on site" shape="rounded" style={imgBlock('440px')} />
                <div>
                    <div style={eyebrow}>Leadership</div>
                    <h2 style={{ ...h2, marginBottom: '16px' }}>A dedicated project manager on every project</h2>
                    <p style={{ ...body, margin: '0 0 24px' }}>
                        Every Leap Edge Renovation project is personally directed by a dedicated project manager. You will never be handed down to a junior team after signing — the people you meet at consultation are the people on your site.
                    </p>
